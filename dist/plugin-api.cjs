'use strict';var chunkBTYKS2RI_cjs=require('./chunk-BTYKS2RI.cjs'),chunkY7ETVPT3_cjs=require('./chunk-Y7ETVPT3.cjs');require('./chunk-L2GAIIQJ.cjs'),require('./chunk-HLQZV4WX.cjs'),require('./chunk-YOP572OB.cjs'),require('./chunk-G4IWH56K.cjs'),require('./chunk-3DBPRVY2.cjs'),require('./chunk-W6BWO3OG.cjs'),require('./chunk-JWU2IDWH.cjs'),require('./chunk-N5FMWEED.cjs'),require('./chunk-5TZ4CSAW.cjs'),require('./chunk-FDPTWMJU.cjs');var me=require('react'),prosemirrorState=require('prosemirror-state'),jsxRuntime=require('react/jsx-runtime'),prosemirrorView=require('prosemirror-view');function _interopDefault(e){return e&&e.__esModule?e:{default:e}}var me__default=/*#__PURE__*/_interopDefault(me);var $={position:"right",defaultSize:280,minSize:200,maxSize:500,resizable:true,collapsible:true,defaultCollapsed:false},te=chunkY7ETVPT3_cjs.v,ne=`
.plugin-host {
  display: flex;
  width: 100%;
  height: 100%;
