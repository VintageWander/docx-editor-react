...
import { F as FontOption, P as PrintOptions } from './print-tbi-ebgs.cjs';
import { R as RenderedDomContext, a as ReactSidebarItem } from './types-BAzM4Rty.cjs';
import { T as TextFormatting, d as ParagraphFormatting, S as SdtType, b as SdtProperties, s as SdtDataBinding, t as HeaderFooter, f as Comment } from './run-DQbevRIu.cjs';
import { T as Translations, a as TFunction } from './index-DHTYI3R-.cjs';
import { D as DocxInput, k as DocumentAgent, a as ContentControlFilter, h as ContentControlValue } from './createDocument-BL_bMrw1.cjs';
export { j as CreateEmptyDocumentOptions, s as createDocumentWithText, t as createEmptyDocument } from './createDocument-BL_bMrw1.cjs';
import { E as EditorHandle } from './types-B6tRV_OC.cjs';
import 'prosemirror-model';
import './agentApi-D6BWmIeb.cjs';
