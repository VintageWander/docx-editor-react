import { C as ContentControlInfo, a as ContentControlFilter, D as DocxInput } from './createDocument-lAJWlRrr.js';
...
import { D as Document, S as StyleDefinitions, T as Theme } from './document-DNfO4ECj.js';
export { a as DocxPackage, R as Relationship, b as Style } from './document-DNfO4ECj.js';
import { A as AgentCommand, R as Range, S as SelectionContext$1, a as AgentContext, P as Position } from './agentApi-DQnHfeGH.js';
export { b as AIAction, c as AIActionRequest, d as AgentResponse, e as ApplyStyleCommand, f as ApplyVariablesCommand, D as DEFAULT_AI_ACTIONS, g as DeleteTextCommand, F as FormatParagraphCommand, h as FormatTextCommand, I as InsertHyperlinkCommand, i as InsertImageCommand, j as InsertTableCommand, k as InsertTextCommand, l as ParagraphContext, m as ParagraphOutline, n as ReplaceTextCommand, o as SectionInfo, p as SetVariableCommand, q as StyleInfo, r as SuggestedAction, s as comparePositions, t as createCollapsedRange, u as createCommand, v as createRange, w as getActionDescription, x as getActionLabel, y as isPositionInRange } from './agentApi-DQnHfeGH.js';
import { T as TextFormatting, D as DocumentBody, P as Paragraph, H as Hyperlink, R as Run, a as Table, S as SdtType, b as SdtProperties, c as SectionProperties, W as Watermark, d as ParagraphFormatting, C as ColorValue, e as ThemeColorSlot } from './run-DQbevRIu.js';
export { B as BlockContent, f as Comment, g as CommentRangeEnd, h as CommentRangeStart, i as Deletion, E as Endnote, F as Footnote, I as Image, j as Insertion, L as ListLevel, M as MoveFrom, k as MoveTo, N as NumberingDefinitions, l as ParagraphContent, m as RunContent, n as TableCell, o as TableRow, p as TextContent, q as TrackedChangeInfo, r as TrackedRunChange } from './run-DQbevRIu.js';
