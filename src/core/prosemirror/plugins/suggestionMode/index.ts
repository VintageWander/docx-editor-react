 ...
 * to do anything** — both adapters (`@/react`,
 * `the vue adapter`) auto-mount this inside the `DocxEditor`
 ...
 * @example
 * ```ts
 * import { createSuggestionModePlugin } from '@/core/prosemirror/plugins';
 *
