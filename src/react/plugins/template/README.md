...
```tsx
import { DocxEditor, PluginHost, templatePlugin } from 'docx-editor-react';
...
```tsx
import { DocxEditor, PluginHost } from 'docx-editor-react';
import { createPlugin } from 'docx-editor-react';
...
```tsx
import { processTemplate } from 'docx-editor-react';
