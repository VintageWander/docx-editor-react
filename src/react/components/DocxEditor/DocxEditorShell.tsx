...
import type { SectionProperties, TabStop } from '@/core/types/document';
import type { TrackedChangesResult } from '@/core/prosemirror/utils/extractTrackedChanges';
...
import type { HeadingInfo } from '@/core/utils';
