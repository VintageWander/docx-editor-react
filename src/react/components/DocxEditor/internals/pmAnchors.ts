...
import { findBodyPmAnchors } from '@/core/layout-bridge';
import type { Document, SectionProperties } from '@/core/types/document';

// `findParaIdRange` moved to `@/core/prosemirror/paraText`;
