...
import { fromProseDoc } from '@/core/prosemirror/conversion';
import type { ExtensionManager } from '@/core/prosemirror/extensions';
import { stripScrollFlag } from '@/core/editor';
import type { Document, Theme, StyleDefinitions } from '@/core/types/document';

// Editor + ProseMirror CSS ships in the single `docx-editor-react/styles.css`
// bundle (see src/react/styles/editor.css); consumers import that once.
