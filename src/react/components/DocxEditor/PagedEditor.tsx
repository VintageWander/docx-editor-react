...
// Layout engine
import type { Layout } from '@/core/layout-engine';
import type { ScrollToParaIdOptions } from '@/core/utils';

// Layout bridge
import { DEFAULT_PAGE_HEIGHT_PX } from '@/core/layout-bridge';
...
export interface PagedEditorProps {
  ...
  extensionManager?: import('@/core/prosemirror/extensions').ExtensionManager;
