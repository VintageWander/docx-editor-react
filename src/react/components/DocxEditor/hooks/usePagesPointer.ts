...
import type { CaretPosition, SelectionRect } from '@/core/layout-bridge';
import {
  clickToPosition,
  clickToPositionDom,
...
} from '@/core/layout-bridge';
import type { FlowBlock, Layout, Measure } from '@/core/layout-engine';
import { addColumnRight, addRowBelow } from '@/core/prosemirror';
import {
  captureInlinePositionEmu,
  findImageElement as coreFindImageElement,
  hitTestImage,
} from '@/core/layout-painter';
import type { WrapType } from '@/core/docx/wrapTypes';
import { findWordBoundaries } from '@/core/utils';
...
} from '@/core/prosemirror/cellDragSelection';
