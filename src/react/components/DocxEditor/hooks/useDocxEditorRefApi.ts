...
} from '@/core/prosemirror/queries';
import {
  applyFormatting,
  setParagraphStyle,
  insertBreak,
} from '@/core/prosemirror/applyFormatting';
import {
  ContentControlNotFoundError,
  type ContentControlFilter,
  type ContentControlValue,
} from '@/core/agent';
import type { DocxInput, ScrollToParaIdOptions } from '@/core/utils';
import { getCachedNumberingMap } from '@/core/docx';
import type { DocxEditorRef } from '../../DocxEditor';
import type { PagedEditorRef } from '../PagedEditor';
import {
  addCommentToRange,
  applyProposedChange,
} from '@/core/prosemirror/commentOps';
import type { CommentIdAllocator } from '@/core/prosemirror/commentIdAllocator';
