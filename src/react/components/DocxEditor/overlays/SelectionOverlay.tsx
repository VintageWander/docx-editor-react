...
import type { SelectionRect, CaretPosition } from '@/core/layout-bridge';
...
export function useSelectionOverlay(
  ...
  layout: import('@/core/layout-engine').Layout | null,
  blocks: import('@/core/layout-engine').FlowBlock[],
  measures: import('@/core/layout-engine').Measure[]
): {
  selectionRects: SelectionRect[];
  caretPosition: CaretPosition | null;
} {
  ...
  useEffect(() => {
    ...
    import('@/core/layout-bridge').then(
