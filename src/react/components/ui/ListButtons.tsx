...
import type { NumberFormat } from '@/core/types/document';
...
export type { ListType, ListState } from '@/core/utils/listState';
import type { ListState } from '@/core/utils/listState';
