...
import type { Document, Theme } from '@/core/types/document';
...
import { DocumentAgent } from '@/core/agent';
import { DefaultLoadingIndicator, DefaultPlaceholder, ParseError } from './DocxEditorHelpers';
import { type DocxInput } from '@/core/utils';
import type { FontDefinition, ScrollToParaIdOptions } from '@/core/utils';
import { useFontLifecycle } from '../hooks/useFontLifecycle';
import { useTableSelection } from '../hooks/useTableSelection';
import { useDocumentHistory } from '../hooks/useHistory';

// Extension system
import { createStarterKit } from '@/core/prosemirror/extensions';
import { ExtensionManager } from '@/core/prosemirror/extensions';
import {
  createSuggestionModePlugin,
  setSuggestionMode,
} from '@/core/prosemirror/plugins';
...
import type { ContentControlFilter, ContentControlValue } from '@/core/agent';
import {
  acceptChange,
  rejectChange,
  acceptChangeById,
...
interface EditorState {
  ...
  paragraphTabs: import('@/core/types/document').TabStop[] | null;
...
// `@/core/docx` so React + Vue share the same
